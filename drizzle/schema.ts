...
export const users = mysqlTable("users", {
  ...
  /** Phase 24: SQLite also supports "agent"; MySQL migration needed if agents are used with MySQL. */
 ...
 */
export const gameSubmissions = mysqlTable("gameSubmissions", {
  id: int("id").autoincrement().primaryKey(),
  userId: int("userId").notNull(),
  username: varchar("username", { length: 64 }).notNull(),
  matchResults: json("matchResults").notNull(), // JSON array of match predictions
